...
const PAYMENT_APPS = [
  ...
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 24 24" className="w-6 h-6" fill="currentColor" style={{ color: '#4285F4' }}>
    ...
    href: (amount, note) =>
      `https://pay.google.com/gp/p/send?amount=${amount}&currencyCode=USD&description=${encodeURIComponent(note)}`,
  },
  {
    label: 'Venmo',
    sub: 'Pay via Venmo',
